...
int main(void)
{
  ...
  osThreadDef(procTask, StartProcTask0, osPriorityNormal, 0, 128);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : HIGH_LOW_Pin RF_B1_B2_Pin BLE_SLEEP_Pin BLE_UART_SW_Pin
                           RF_OPT_Pin BLE_GPO_Pin I2C1_WP_Pin */
  ...
  /*Configure GPIO pin : BLE_GPI_Pin */
  GPIO_InitStruct.Pin = BLE_GPI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BLE_GPI_GPIO_Port, &GPIO_InitStruct);
