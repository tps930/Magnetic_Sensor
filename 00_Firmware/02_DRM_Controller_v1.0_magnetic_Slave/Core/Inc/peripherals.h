...
#define SetBLEWAKEUP(state)	HAL_GPIO_WritePin(BLE_SLEEP_GPIO_Port, BLE_SLEEP_Pin, state)
#define SetBLEUART(state)	HAL_GPIO_WritePin(BLE_UART_SW_GPIO_Port, BLE_UART_SW_Pin, state)
